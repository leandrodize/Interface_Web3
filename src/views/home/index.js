        ...
        TransHumans.methods
          ...
          .on("receipt", () => {
            ...
            toast({
              ...
              description: "No definas tu generacion.",
              status: "success",
            });
          })
          .on("error", (error) => {
        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          >
            ...
            <Text as={"span"} color={"blue.400"}>
              no define su generacion
            </Text>
          </Heading>
          <Text color={"gray.500"}>
            Trasn Humans es una colección de Avatares randomizados cuya metadata
            es almacenada on-chain. Poseen características únicas y sólo hay 10000
            en existencia.
          </Text>
          <Text color={"blue.500"}>
            Cada Trans Human se genera de forma secuencial basado en tu address,
            usa el previsualizador para averiguar cuál sería tu Trans Human si
